...
describe('Room and setupRoom', () => {
  ...
  test('Room consumer transport management', () => {
    const room = new Room({ name: 'Test Room', url: 'http://test.url', hostEmail: 'host@test.com', password: 'password' });
  ...
  test('Room member management', () => {
    const room = new Room({ name: 'Test Room', url: 'http://test.url', hostEmail: 'host@test.com', password: 'password', maxParticipants: 2 });
